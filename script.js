...
function drawVector() {
    ...
    // فلش بردار اصلی (نوک بزرگ‌تر)
    drawArrowHead(x1, y1, Math.atan2(y1 - cy, x1 - cx), "#10b981", 16);
    ...
    // فلش بردار ضرب‌شده (نوک بزرگ‌تر)
    drawArrowHead(x2, y2, Math.atan2(y2 - cy, x2 - cx), "#ef4444", 20);
